...
class Orientacao(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Professor', null=True)
    orientandos = models.ManyToManyField(User, related_name='orientandos', blank=True)
